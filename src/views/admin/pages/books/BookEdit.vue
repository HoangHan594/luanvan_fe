    ...
    <div class="container mt-3">
      ...
      <div class="form">
        <form @submit.prevent="updateBook()">
          ...
          <div class="form-item">
            <label class="label" for="genre">Thể loại:</label><br />
            <select class="input" id="genre" v-model="formData.genre">
          ...
          <div class="form-item">
            <label class="label" for="weight">Trọng lượng:</label><br />
            <input class="input" type="text" id="weight" v-model="formData.weight" />
          </div>

          <div class="form-item">
            <label class="label" for="packagingSize">Kích thước bao bì:</label><br />
            <input class="input" type="text" id="packagingSize" v-model="formData.packagingSize" />
          </div>

          <div class="form-item">
            <label class="label" for="pageNumber">Số trang:</label><br />
            <input class="input" type="text" id="pageNumber" v-model="formData.pageNumber" />
          </div>
  ...
  methods: {
    ...
    async retrieve(bookId) {
      try {
        ...
        if (book) {
          ...
          this.formData.genre = book.genre;
          ...
          this.formData.weight = book.weight;
          this.formData.packagingSize = book.packagingSize;
          this.formData.pageNumber = book.pageNumber;
        } else {
    ...
    async updateBook() {
      try {
        ...
        formData.append("packagingSize", this.formData.packagingSize);
        formData.append("pageNumber", this.formData.pageNumber);
